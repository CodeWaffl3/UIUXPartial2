    ...
    <div className='socialMediaAlbertoContent'>
        ...
        <div className='socialMedias'>
            <div className='socialMediaInfo'>
                ...
                <a className='socialMediaLink' href="tel:+523336765896" target="_blank">+52 33 36 76 58 96</a>
            </div>
            <div className='socialMediaInfo'>
                <img className='socialMediaLogo' src={gmailLogo} alt="Gmail Logo" />
                <a className='socialMediaLink' href="mailto:albertomoralesvizc@gmail.com" target="_blank">albertomoralesvizc@gmail.com</a>
            </div>
            <div className='socialMediaInfo'>
                <img className='socialMediaLogo' src={linkedinLogo} alt="Linkedin Logo" />
                <a className='socialMediaLink' href="https://www.linkedin.com/in/alberto-morales-vizcarra-245150183" target='_blank'>https://www.linkedin.com/in/alberto-morales-vizcarra-245150183</a>
            </div>
            <div className='socialMediaInfo'>
                <img className='socialMediaLogo' src={githubLogo} alt="Github Logo" />
                <a className='socialMediaLink' href="https://github.com/albertomoralesv" target="_blank">https://github.com/albertomoralesv</a>
            </div>
        </div>
    </div>
  );
